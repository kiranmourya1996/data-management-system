          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">DataTable with User Management</h3>
                <a href="{{ route('exportCsv')}}"  class="btn btn-primary" style="    float: right;    margin-left: 1%;">Download CSV</a>
                 @if(Auth::user()->hasRole('user')||Auth::user()->hasRole('admin'))
                <a href="/users/create" class="btn btn-primary" style="    float: right;">Create User</a>
                @endif
              </div>
              <!-- /.card-header -->
              <div class="card-body">
