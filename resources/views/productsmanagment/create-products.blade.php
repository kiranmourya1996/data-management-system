              ...
              <form class='needs-validation' method="post" action="{{ route('products.store') }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group {{ $errors->has('description') ? ' has-error ' : '' }}">
                    ...
                    <textarea type="text" name="description"  class="form-control" id="exampleInputdescription" value="{{old('description')}}" placeholder="Enter description">{{old('description')}}</textarea>
                  ...
                  <div class="form-group {{ $errors->has('price') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="price" class="form-control" id="exampleInputPrice" placeholder="Enter price" value="{{old('price')}}">
                    @if ($errors->has('price'))
                            <span class="error-block">
                   ...
                   <div class="form-group {{ $errors->has('image') ? ' has-error ' : '' }}">
                    <label for="exampleInputImage"> Image</label>
                      ...
                      <img src="" id="imgPrime" height="100" width="100" style="margin-top: 10px;display:none;">
